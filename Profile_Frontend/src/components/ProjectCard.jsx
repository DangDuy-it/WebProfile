...
<div className="overflow-hidden relative rounded-xl group">
    ...
    {(onEdit || onDelete) && (
        <div className="absolute top-3 left-0 right-0 px-3 flex justify-between items-center z-30 opacity-0 group-hover:opacity-100 transition-all duration-300 transform -translate-y-2 group-hover:translate-y-0">
            {/* Nút Sửa - Bên trái */}
            {onEdit && (
                <button 
